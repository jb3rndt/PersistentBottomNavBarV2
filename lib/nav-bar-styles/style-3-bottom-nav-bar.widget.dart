...
class BottomNavStyle3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double itemWidth = ((size.width -
            ((this.navBarEssentials!.padding?.left ?? size.width * 0.05) +
                (this.navBarEssentials!.padding?.right ?? size.width * 0.05))) /
    ...
    return Container(
      ...
      padding: EdgeInsets.only(
          ...
          left: this.navBarEssentials!.padding?.left ?? size.width * 0.05,
          right: this.navBarEssentials!.padding?.right ?? size.width * 0.05,
